...
"""
returns Server,Node,SOA,Timestamp
"""
...
def measurement_list():
    ...
    listan = [
        ...
        # {"msm_id": 23955520, "start": 1581513053},
        {"msm_id": 1413717, "start": 1581513053, "stop": 1581514500},
        ]
            ...
            try:
                ...
                for opt in msg.options:
                    if opt.otype == dns.edns.NSID:
                        d[str(opt.data.decode("utf-8"))].append([time, soa_serial])
            except:
                 next
    return d
...
if __name__ == '__main__':
    ...
    # for item in mapping:
    #     print(f"{item} -> {mapping[item]}")

    prel_output = json.dumps(mapping)
    print(prel_output)
